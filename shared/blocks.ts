...
export enum BlockType {
  ...
  // Biome surfaces:
  Snow = 16,
  // Plants & decorations (Sapling keeps 17 — it's in live saves):
  Sapling = 17,
  TallGrass = 18,
  Flower = 19,
  DeadBush = 20,
...
export const BLOCKS: Record<BlockType, BlockDef> = {
  ...
  [BlockType.Stone]: { id: BlockType.Stone, name: "Stone", color: [0.5, 0.5, 0.52], solid: true, transparent: false, drops: "stone", hardness: 2.0, tool: "pickaxe", requiresTool: true, mineXp: 5 },
  ...
  [BlockType.Sapling]: { id: BlockType.Sapling, name: "Sapling", color: [0.3, 0.6, 0.25], solid: false, transparent: true, drops: "sapling", hardness: 0.3, tool: "axe", requiresTool: false, cross: true },
